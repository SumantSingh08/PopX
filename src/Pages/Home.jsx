        ...
        <div className=' w-full min-h-screen px-3 bg-slate-300 md:p-24 '>
            <div className=' flex flex-col  fixed bottom-6  md:relative '>
                ...
                <div className='w-full flex flex-col  gap-2 mt-6 text-center  items-center md:flex-col  md:justify-center md:items-center  md:gap-5  md:mt-10'>
                    <Button onClick={() => navigate("/signup")} className='w-full  mr-3  md:max-w-sm text-sm font-semibold bg-violet-600 text-white rounded-sm cursor-pointer hover:bg-violet-700'>
                        Create Account
                    </Button>
                    <Button onClick={() =>navigate("/login")} className='w-full mr-3 md:max-w-sm  text-sm font-semibold bg-purple-400 text-black rounded-sm cursor-pointer hover:bg-purple-400'>
